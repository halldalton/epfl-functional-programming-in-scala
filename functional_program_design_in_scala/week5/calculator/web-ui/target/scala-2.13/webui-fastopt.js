...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  return $as_sci_Map(namedExpressions.map__F1__sc_IterableOps(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, namedExpressions$1) {
    return (function(pair$2) {
      ...
      var self = pair.$$und1$f;
      $m_Lcalculator_Signal$();
      var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this$1, pair$1, namedExpressions$1$1) {
        return (function() {
          return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($m_Lcalculator_Calculator$().getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr($as_T(pair$1.$$und1$f), namedExpressions$1$1), namedExpressions$1$1)
        })
      })($this, pair, namedExpressions$1));
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, remainingCharsCount$1) {
    return (function() {
      return $this.color$1__p1__Lcalculator_Signal__T(remainingCharsCount$1)
    })
  })(this, remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_TweetLength$.prototype.color$1__p1__Lcalculator_Signal__T = (function(remainingCharsCount$1) {
